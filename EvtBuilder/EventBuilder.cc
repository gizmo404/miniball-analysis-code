  ...
  :Settings(settings)
{
  ...
  //create on beam tree
  OnBeamTree = new TTree("tr","Tree for on beam data of transfer setup@Miniball");
  ...
  if(!Settings->SourceRun())
      ...
      if(Settings->VerboseLevel() > 0)
	{
      ...
      //create on beam tree
      OnBeamBackgroundTree = new TTree("tr","Tree for on beam background data of transfer setup@Miniball");
      ...
      if(Settings->VerboseLevel() > 0)
	{
      ...
      OffBeamTree = new TTree("tr","Tree for off beam data of transfer setup@Miniball");
  ...
  if(!Settings->IncludeScaler())
      ...
      if(Settings->VerboseLevel() > 0)
	{
      ...
      ScalerTree = new TTree("sc","Tree for scaler data of transfer setup@Miniball");
