...
bool UnpackedEvent::DecodeIoRegData(int SubEventID, int SubEventWordCount, char* SubEventData)
{
  if(Settings->VerboseLevel() > 2)
    {
      cout<<endl<<"start of "<<__PRETTY_FUNCTION__<<endl;
  ...
  if(Settings->VerboseLevel() > 1)
    {
      ...
      cout<<"Subevent "<<SubEventID<<": i/o reg data, WordCount = "<<SubEventWordCount<<endl;
    }
