...
public:
  ...
  inline void EventNumber(long long EventNumber)
  {
  ...
  inline size_t NumberOfAdcs()
  {
    return adcData.size();
  };

  inline size_t NumberOfDgfs()
  {
    return dgfData.size();
  };

  inline long long EbisTime()
  {
    return ebisTime;
  };

  inline long long T1Time()
  {
    return t1Time;
  };

  inline long long SuperCycleTime()
  {
    return superCycleTime;
  };
  
  inline long long EventNumber()
  {
    return eventNumber;
  };

  inline unsigned short SubEventNumber()
  {
    return subEventNumber;
  };

  inline AdcData* Adc(size_t Index)
  {
    return &(adcData.at(Index));
  };

  inline DgfData* Dgf(size_t Index)
  {
    return &(dgfData.at(Index));
  };
