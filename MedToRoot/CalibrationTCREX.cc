#include "CalibrationTCREX.hh"
#include "TMath.h"

using namespace std;
using namespace TMath;

CalibrationTCREX::CalibrationTCREX(){}

CalibrationTCREX::CalibrationTCREX(const char* filename){
...
void CalibrationTCREX::ReadCalibration(){
...
void CalibrationTCREX::PrintCalibration(){
...
double CalibrationTCREX::DgfEnergy(int dgf, int chan, unsigned short raw){
...
double CalibrationTCREX::AdcEnergy(int adc, int chan, unsigned short raw){
...
int CalibrationTCREX::PosFBCDRing(int Quad, unsigned short raw){ // PosStrip CD for CREX2016
...
int CalibrationTCREX::PosFBCDStrip(int Quad, unsigned short raw){ // PosStrip CD for CREX2016
...
int CalibrationTCREX::PosRing(int Quad, unsigned short raw) { // PosStrip CD for CREX2012
...
int CalibrationTCREX::PosStrip(int Quad, unsigned short raw){ // PosStrip CD for CREX2012
...
int CalibrationTCREX::StripPosBarrel(unsigned short strraw, unsigned short rearraw){
